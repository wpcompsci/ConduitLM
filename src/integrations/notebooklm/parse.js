    ...
    scope.NLM_Parse = {
        ...
        parseCreateNotebook: function (responseText, title) {
            ...
            try {
                ...
                const match = payloadStr.match(/\b[0-9a-fA-F]{8}-(?:\d|[a-fA-F]){4}-(?:\d|[a-fA-F]){4}-(?:\d|[a-fA-F]){4}-(?:\d|[a-fA-F]){12}\b/);
        ...
        parseAddSource: function (responseText) {
            ...
            if (!responseItem[1] && !responseItem[2]) throw { code: "parse", message: "Add Source payload missing" };
