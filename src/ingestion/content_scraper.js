// src/ingestion/content_scraper.js
  ...
  const platforms = [
    {
      ...
      injectUI: function () {
        ...
        const findTarget = () => {
          ...
          return (
            document.querySelector('div.flex.items-center.gap-2.pr-1') ||
        ...
        const updateButtonPosition = () => {
          ...
          if (targetElement) {
            ...
            // Removed unused rect assignment. Position safely using targetElement bounds.
            const targetRect = targetElement.getBoundingClientRect();

            portal.style.top = `${targetRect.top + window.scrollY + 5}px`;
            portal.style.left = `${targetRect.left + window.scrollX - 160}px`; // Shift left of the buttons
    ...
    },
    {
      ...
      injectUI: function () {
        const updateButtonPosition = () => {
          ...
          const targetElement =
            document.querySelector('div.right-section') || document.querySelector('mat-toolbar');
